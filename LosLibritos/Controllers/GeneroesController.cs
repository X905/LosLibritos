...
namespace LosLibritos.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Genero,NombreGenero")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Genero,NombreGenero")] Genero genero)
        {
            if (ModelState.IsValid)
            {
